        ...
        while True:
            ...
            for user in response["Users"]:
                ...
                try:
                    ...
                    print(
                        f"✗ Error al eliminar {username} ({email}): {error_code} - {error_message}"
                    )
...
if __name__ == "__main__":
    ...
    print(
        "ADVERTENCIA: Este script eliminará PERMANENTEMENTE todos los usuarios del User Pool de Cognito."
    )
