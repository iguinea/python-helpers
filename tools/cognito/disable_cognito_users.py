    ...
    try:
        ...
        while True:
            ...
            for user in response['Users']:
                ...
                if status == 'DISABLED':
                    print(f"Usuario {username} ({email}) ya está desactivado - Saltando")
                    continue
                ...
                try:
                    ...
                    print(f"✗ Error al desactivar {username} ({email}): {error_code} - {error_message}")
...
if __name__ == "__main__":
    ...
    print("ADVERTENCIA: Este script desactivará TODOS los usuarios del User Pool de Cognito.")
